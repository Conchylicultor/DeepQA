...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        datasetArgs.add_argument('--corpus', choices=['cornell', 'opensubs', 'scotus'], default='cornell', help='corpus on which extract the dataset.')  # TODO: Replace by cst registered in textdata
