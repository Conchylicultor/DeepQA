...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        datasetArgs.add_argument('--twitter_name', type=str, help='Name of twitter account to download/use data from')
        datasetArgs.add_argument('--max_tweets', type=int, default=3200, help='Number of twitter to use at most')
        ...
        datasetArgs.add_argument('--filterVocab', type=int, default=1, help='remove rarely used words (by default words used only once). 0 to keep all words.')
